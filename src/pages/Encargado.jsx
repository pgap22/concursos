...
const Encargado = () => {
  ...
  const clearSuccessMessage = () => {
    navigate("/encargado", { state: { successMessage: null } });
  };
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-between">
      <header className="bg-white py-4 px-8 shadow-md flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-blue-500">Encargado</h1>
      ...
      <main className="p-4 flex-grow">
        <div className='w-full flex justify-center'>
          <div className="grid w-full gap-4 grid-cols-1 md:grid-cols-3 max-w-4xl">
            <IconButton text="Crear Concursante" to="/encargado/crear-concursante" icon={<FaUserPlus />} />
            {/* <IconButton text="Crear Jurado/Encargado" to="/encargado/crear-jurado" icon={<FaUserPlus />} /> */}
            <IconButton text="Crear Concurso" to="/encargado/crear-concurso" icon={<FaPlus />} />
          </div>
        </div>
        {loading ? (
          <LoadingSpinner />
